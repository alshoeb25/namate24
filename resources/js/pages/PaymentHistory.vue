  ...
  setup() {
    ...
    const formatType = (type) => {
      const types = {
        ...
        tutor_unlock_requirement: 'Unlocked Requirement',
        tutor_unlock_contact: 'Unlock Contact',
        tutor_approach: 'Approach Tutor',
    ...
    const getTypeClass = (type) => {
      const classes = {
        ...
        tutor_unlock_requirement: 'bg-red-100 text-red-700',
        tutor_unlock_contact: 'bg-orange-100 text-orange-700',
        tutor_approach: 'bg-cyan-100 text-cyan-700',
