<template>
  <div class="min-h-screen bg-gray-50 py-8">
    ...
    <div class="max-w-7xl mx-auto px-4">
      <!-- Header with Balance -->
      <div class="bg-gradient-to-r from-blue-500 to-indigo-600 rounded-2xl shadow-lg p-6 md:p-8 mb-6 text-white">
          ...
          <div class="bg-white rounded-2xl shadow-md p-6">
            ...
            <div v-else class="space-y-3">
              ...
              <div v-if="wallet.transactions.total > 5" class="text-center pt-4">
                <button
                  @click="activeTab = 'coin-transactions'"
                  class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-indigo-700 transition shadow-md"
                >
          ...
          <div class="bg-white rounded-2xl shadow-md p-6">
            ...
            <div v-else>
              ...
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <router-link to="/student/wallet/payment-history" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700">
