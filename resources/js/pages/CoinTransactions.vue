...
export default {
  ...
  setup() {
    ...
    const formatType = (type) => ({ purchase: 'Purchase', enquiry_post: 'Posted Requirement', enquiry_unlock: 'Unlocked Contact', tutor_unlock_requirement: 'Unlocked Requirement', tutor_unlock_contact: 'Unlock Contact', tutor_approach: 'Approach Tutor', referral_bonus: 'Referral Bonus', referral_reward: 'Referral Reward', booking: 'Booking', refund: 'Refund', admin_credit: 'Admin Credit', admin_debit: 'Admin Debit' }[type] || type);
    const getTypeClass = (type) => ({ purchase: 'bg-green-100 text-green-700', enquiry_post: 'bg-purple-100 text-purple-700', enquiry_unlock: 'bg-indigo-100 text-indigo-700', tutor_unlock_requirement: 'bg-red-100 text-red-700', tutor_unlock_contact: 'bg-orange-100 text-orange-700', tutor_approach: 'bg-cyan-100 text-cyan-700', referral_bonus: 'bg-blue-100 text-blue-700', referral_reward: 'bg-purple-100 text-purple-700', booking: 'bg-red-100 text-red-700', refund: 'bg-yellow-100 text-yellow-700', admin_credit: 'bg-green-100 text-green-700', admin_debit: 'bg-red-100 text-red-700' }[type] || 'bg-gray-100 text-gray-700');
